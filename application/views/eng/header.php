          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
				...
				<ul class="dropdown-menu" role="menu" class="active">
					<li <?=$stock_list?>><a href="/Stock/list">STOCK LIST</a></li>
					<li <?=$stock_category?>><a href="/StockCategory/list">STOCK CATEGORY LIST</a></li>
					<li <?=$stock_seller?>><a href="/StockSeller/list">STOCK SELLER LIST</a></li>
				</ul>
			</li>
